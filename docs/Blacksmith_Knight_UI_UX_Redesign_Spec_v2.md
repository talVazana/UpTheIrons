...
Use a large atmospheric forge/workshop visual or abstract blacksmithing
motif with a dark readability overlay. **Do not use a hero image
containing a person as the focal subject.** The site is personal-use
oriented and should emphasize the craft, tools, materials, workshop and
the owner's identity rather than depicting a generic blacksmith/person.
...
# 2A. Site Owner Logo --- `kiko.png`

The site owner will provide a logo file named:

``` text
kiko.png
```

The builder should use this actual logo as the site's brand mark.

## Logo rules

-   Do not replace the owner's logo with a generic blacksmith icon.
-   Do not redraw the logo unless explicitly requested.
-   Do not distort the logo.
-   Preserve its aspect ratio.
-   Use the logo consistently in the header and appropriate brand
    locations.
-   Use a suitable treatment for dark backgrounds if the logo requires
    one, but do not permanently alter the source asset.
-   The logo should remain recognizable at desktop and mobile sizes.
-   If the logo has transparent background, preserve transparency.
-   If the supplied logo has a background, the builder should visually
    integrate it without creating an ugly rectangular image box.
-   The logo is the owner's identity; forge imagery is supporting
    atmosphere.
...
``` text
Desktop:
[ KIKO LOGO ]  BLACKSMITH KNIGHT / FORGING HEAVEN

Mobile:
[ KIKO LOGO ]  BLACKSMITH KNIGHT
```

The exact relationship between the logo and text should be determined
after inspecting `kiko.png`.

## Important

The builder should wait until `kiko.png` is available before making
final logo sizing/cropping decisions.
...
for the global page. Add depth with subtle workshop/forged-metal motifs
rather than relying only on a flat background.
...
# 5. Main Opening Section --- No Traditional Hero

The opening section is the most important redesign, but it should **not
be treated as a conventional marketing hero**. This is a personal
blacksmithing site rather than a commercial landing page.
...
The supplied forge image is the mood reference, while the supplied
forged-metal three-panel image is the **card-style reference**. The card
style should be treated as a major visual language for the site.

## 5.3 Opening visual treatment
...
# 8. Forge Pillars Section --- Forged Metal Card System
...
> Create a visual "foundation of the craft" using forged-metal
> plates/cards rather than ordinary flat web cards.

The supplied three-panel reference establishes the desired card
language. Ignore the text/content in that image; use only its visual
construction as inspiration.
...
Use Bento Grid principles for the overall arrangement, but the
individual cards should share a **forged-metal plate design language**.

The cards should look more like mounted/forged workshop plaques than
standard rounded web cards.

Do not simply place a normal HTML card inside a metal-colored
background.
...
# 9. Forge Card Design --- Forged Plaque Style

## 9.1 Forged plaque construction

The card should visually resemble a forged or machined metal plate.

Characteristics inspired by the supplied reference:

-   substantial outer frame
-   layered metal border
-   inset inner border
-   clipped/chamfered corners
-   subtle bevel/highlight
-   darkened metal interior
-   small rivet/bolt details where appropriate
-   controlled scratches/patina
-   strong depth between outer frame and content surface
-   optional orange heat/glow on selected cards

The effect must remain modern and usable; it should not look like a
literal game UI.

## 9.2 Image area

Cards may have a visual area, but the metal plaque frame must remain
...
Use imagery intentionally. Prefer **objects, materials, tools and
workshop environments** over photographs of people.
...
# 45. AI-Generated Images and Motif Generation
...
# 49A. Detailed Forged-Metal Card Specification

The supplied three-panel reference image is a key visual reference for
cards.

**Ignore the text in that reference image.**

Use its physical construction and visual character.

## Desired card anatomy
...
Each important feature card should potentially contain:

1.  Outer dark metal frame
2.  Raised/beveled border
3.  Inner recessed panel
4.  Chamfered or mechanically shaped corners
5.  Small rivets/bolts
6.  Subtle scratches/patina
7.  Directional metallic highlights
8.  Dark interior surface
9.  Orange heat accent where appropriate
10. Strong readable typography

## Three visual states

### Cold iron

Used for normal cards.
...
Used for hover or featured cards.

-   slightly warmer steel
-   orange edge light
-   subtle glow

### Hot iron

Used only for selected/high-priority content.

-   stronger orange edge
-   subtle inner glow
-   slightly brighter highlight

Do not make every card "hot."
...
-   chamfered corners
-   clipped corners
-   stepped metal frames

over generic large rounded rectangles.

Small radius can still be used for usability, but the dominant
silhouette should feel mechanically forged/machined.

## Rivets

Small rivets can be decorative.
...
-   appear consistently
-   not be added to every tiny UI element

## Texture

Metal texture should be subtle enough that text remains extremely
readable.

Do not use a noisy texture behind body text.
...
-   slight elevation
-   small metallic highlight movement
-   slightly stronger orange accent
-   image scale around 1.02--1.04 when an image exists
-   200--300ms transition

Avoid:

-   aggressive 3D rotation
-   large perspective transforms
-   excessive glow
-   shaking
-   spinning
...
# 49B. No-Person Visual Policy

This is a personal blacksmithing knowledge site.

Do not make a person the visual centerpiece of the homepage.
...
-   workbench
-   steel billets
-   finished forged objects
-   metal textures
-   workshop signs
-   abstract forged-metal motifs
-   owner's logo

A person may appear incidentally in content where the content itself
requires it, such as an instructional video thumbnail, but the site's
primary branding should not depend on a photographed/generated
...
> **Walking into a dark blacksmith workshop at night --- surrounded by
> tools, forged metal, hot steel and firelight.**
